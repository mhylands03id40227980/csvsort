...
def get_key(row, columns, numeric_column):
    ...
    if (numeric_column):
        ...
        for column in columns:
            #If there are non-numeric values in a row which is identified as numeric use 1000 instead - 
            #This will catch empty rows and whatnot. Will ensure empty rows are sorted together
            #This could be changed to exclude non-numerical entries
            try:
